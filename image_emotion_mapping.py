...
def image_emotion_mapping(path):
    # 读取emotion文件
    df_emotion = pd.read_csv(r'D:\git-test\facial-expression-recognition\dataset\fer_emotion.csv', header = None)
    # 查看该文件夹下所有文件
...
def main():
    # 指定文件夹路径
    train_set_path = 'face_images/fer_train'
    verify_set_path = 'face_images/fer_test'
